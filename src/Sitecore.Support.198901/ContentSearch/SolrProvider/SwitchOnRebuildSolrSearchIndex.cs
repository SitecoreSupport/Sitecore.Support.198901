...
namespace Sitecore.Support.ContentSearch.SolrProvider
{
  ...
  {
    public SwitchOnRebuildSolrSearchIndex(string name, string core, string rebuildcore, IIndexPropertyStore propertyStore, ISolrOperationsFactory solrOperationsFactory)
      : this(name, core, rebuildcore, propertyStore)
    {
    }

    public SwitchOnRebuildSolrSearchIndex(string name, string core, string rebuildcore, IIndexPropertyStore propertyStore)
